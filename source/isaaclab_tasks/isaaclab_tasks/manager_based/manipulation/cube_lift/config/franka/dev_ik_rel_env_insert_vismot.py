...
class FrankaDevEnvVMCfg(dev_env_cfg.FrankaDevEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.scene.vialrack = glassware.line_vial_rack(pos=[0.3, -0.3, 0.01])
        self.scene.object = glassware.capped_vial(pos=[0.3, -0.3, 0.01], scale =1.0)
        ...
        self.events.reset_object_position = EventTerm(
            ...
            params={
                ...
                "asset2_cfg" : SceneEntityCfg("vialrack"),
                "asset3_cfg" : SceneEntityCfg("stirplate")
            },
        )
