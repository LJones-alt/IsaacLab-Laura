...
from . import agents
#from .agent.rsl_rl_ppo_cfg import Go1RoughRnnTarRunnerCfg
#from .agents.rsl_rl_ppo_cfg import Go1RoughRnnTarRunnerCfg
...
gym.register(
    ...
    kwargs={
       ...
       # "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:Go1RoughRnnTarRunnerCfg",
